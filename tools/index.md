...
<h3><a href="network-scanning/">网络扫描</a></h3>
<p>IOT 设备发现、端口扫描、协议分析工具。<br><em>如：nmap、masscan、Shodan CLI、ZMap</em></p>

<h3><a href="exploitation/">漏洞利用</a></h3>
<p>针对 IOT 设备的 PoC、Exploit 框架及调试工具。<br><em>如：Metasploit 模块、RouterSploit、GDB</em></p>
